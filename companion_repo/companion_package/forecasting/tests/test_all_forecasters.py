...
from base_package.utils.testing import BaseEstimatorTestCollection, ForecasterTestCollection

pytest_generate_tests = configure_pytest_generate_tests(estimator_types="forecaster")


class TestForecaster(BaseEstimatorTestCollection, ForecasterTestCollection):
